...
export default function ChallengeRoom({
  ...
  return (
    <div className="min-h-screen bg-cyber-dark cyber-grid-fast relative overflow-hidden">
      ...
      ></div>
      <div
        className="absolute bottom-40 left-1/4 w-20 h-20 hexagon bg-neon-blue/15 animate-float"
                    ...
                    <CardContent className="p-8">
                      <div className="flex justify-between items-start mb-6">
                        <div>
                          <Badge
                            variant="secondary"
                            className="bg-neon-blue/20 text-neon-blue border-neon-blue/50 mb-2 font-semibold"
                          >
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="text-gray-500 hover:text-neon-blue transition-all"
                        >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                        {currentQuestion.options.map((option, index) => (
                          ...
                          >
                            ...
                            >
                              <span className="font-bold mr-4 text-neon-purple">
