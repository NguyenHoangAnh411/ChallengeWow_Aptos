...
export default function Results() {
  ...
  const handleViewOnExplorer = () => {
    ...
    window.open(`https://explorer.olym3.io/tx/${blockchainInfo.blockHash}`, '_blank');
  };
    ...
    <div className="min-h-screen bg-cyber-dark">
      ...
      <header className="bg-cyber-darker border-b border-gray-800 px-4 py-4">
        <div className="container mx-auto text-center">
          <h1 className="text-3xl font-orbitron font-bold text-neon-blue">Challenge Complete!</h1>
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="animate-winner-glow inline-block p-8 rounded-2xl glass-morphism">
              ...
              <div className="flex justify-center items-center space-x-8 mt-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-neon-blue">{winner.finalScore}</div>
                  <div className="text-sm text-gray-400">Final Score</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-400">+{winner.reward}</div>
                  <div className="text-sm text-gray-400">Tokens Won</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-neon-purple">{winner.avgTime}s</div>
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-orbitron font-bold text-center mb-8">Final Leaderboard</h3>
          ...
          >
            {finalResults.map((player, index) => (
              ...
              >
                <Card className={`glass-morphism rounded-lg p-6 hover:scale-105 transition-all duration-300 ${
                  ...
                  <CardContent className="p-0">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <div className={`text-xl font-semibold ${
                            player.id === currentUser?.id ? "text-neon-purple" : ""
                          }`}>
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-neon-blue">{player.finalScore}</div>
                        <div className="text-sm text-gray-400">
                          <span>{player.correctAnswers}/{player.totalQuestions}</span> correct • 
                          <span className="ml-1">{player.avgTime}s</span> avg
                        </div>
                        <div className="text-sm text-green-400">+{player.reward} tokens</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <CardContent className="p-0">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-sm text-neon-blue">{blockchainInfo.blockHash}</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-neon-blue">{blockchainInfo.network}</span>
                </div>
