            ...
            <div className="flex-1">
              <div className="flex items-center space-x-4 mb-3">
                ...
                <ClientMotion whileHover={{ scale: 1.1 }}>
                  <Badge className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(room.status)} border border-current/30`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="flex items-center space-x-2 p-2 bg-cyber-accent/20 rounded-lg">
                  ...
                  <span className="text-gray-300">{room.currentPlayers || 0}/{room.maxPlayers || 0} Players</span>
                </div>
                <div className="flex items-center space-x-2 p-2 bg-cyber-accent/20 rounded-lg">
                  <Clock className="w-4 h-4 text-neon-purple" />
                  <span className="text-gray-300">{Math.floor((room.duration || 0) / 60)} min rounds</span>
                </div>
                <div className="flex items-center space-x-2 p-2 bg-cyber-accent/20 rounded-lg">
                  <Trophy className="w-4 h-4 text-orange-400" />
                  <span className="text-gray-300">{room.prize || 0} tokens</span>
                </div>
              </div>
            </div>
